...
namespace WIS_PI.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public UsuariosController(WIS_PIContext context)
        {
            _context = context;
        }
        ...
        {
            var wIS_PIContext = _context.Usuario.Include(u => u.Genero);
            return View(await wIS_PIContext.ToListAsync());
        }
        ...
        {
            ViewData["GeneroId"] = new SelectList(_context.Set<Genero>(), "GeneroId", "NomeGenero");
            return View();
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'WIS_PIContext.Usuario'  is null.");
            }
            var usuario = await _context.Usuario.FindAsync(id);
            if (usuario != null)
            {
